...
//void my_print1( const char * fmt,...){
//	    uint8 buffer[64] = {0};
//
//		   char flash_str[] ICACHE_RODATA_ATTR __attribute__((aligned(4))) = fmt;
////		     int n = sizeof(flash_str) / sizeof(flash_str[0]);
////				os_printf("\n the  \n");
//		int n = 4;
//		int i = 0;
//		do{
...
//	os_printf("\r\nready0!!!\r\n");
//	my_print1("helloword %s","lightsnail");
	//	ets_vprintf("\n\n000 PI is %d \n\n", M_PI);
	//	my_print();
	//	my_print2();
	//	UART_SetPrintPort(1);
